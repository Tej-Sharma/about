  ...
  return (
    <header className="text-gray-100 body-font">
      <div className="container mx-auto flex flex-wrap py-5 flex-col md:flex-row items-center">
        ...
        <button className="inline-flex items-center border-0 py-1 px-3 focus:outline-none hover:bg-gray-800 transition duration-500 ease-in-out hover:-translate-x-1 rounded text-base mt-4 md:mt-0">
          Trollgen Tech
